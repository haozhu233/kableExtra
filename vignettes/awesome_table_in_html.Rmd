...
To learn how to generate complex tables in LaTeX, please visit [https://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf](https://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf)

There is also a Chinese version of this vignette. You can find it [here](https://haozhu233.github.io/kableExtra/awesome_table_in_html_cn.html)
...
You can combine the good parts from `kableExtra` & `formattable` together into one piece. Read more at https://haozhu233.github.io/kableExtra/use_kableExtra_with_formattable.html
```{r, message = FALSE, warning=FALSE}
library(formattable)
